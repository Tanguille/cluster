...
- [Skill catalog](.agents/skills/): add-app-to-cluster, backup-restore, cluster-sops, debug-cluster, git-worktree-isolation, k8s-at-home-research, pr-review, prometheus-cluster-health — one `SKILL.md` per directory
